...
export class QuestionsResolver {
  ...
  createQuestion(
    ...
    return this.questionsService.createQuestion(input, context.req.user.id);
  }
  ...
  updateQuestion(
    ...
    return this.questionsService.updateQuestion(input, context.req.user.id);
  }
  ...
  deleteQuestion(
    ...
    return this.questionsService.deleteQuestion(id, context.req.user.id);
  }

  @Mutation(() => Question)
  @RequirePermissions("question:update")
  toggleQuestionStatus(
    @Args("input") input: ToggleQuestionStatusInput,
    @Context() context: any,
  ): Promise<Question> {
    return this.questionsService.toggleQuestionStatus(
      input,
      context.req.user.id,
    );
  }
